...
function Chen2020(θ, funcs)
    ...
    funcs.rxn_p = rxn_BV
    # Open circuit voltage (OCV or OCP) equation
    funcs.OCV_p = OCV_Oregan2020

    return LiC6_Oregan, system_LCO_LiC6_Oregan2021
end

function LiC6_Oregan2021(θ, funcs)
    ...
    funcs.rxn_n = rxn_BV
    # Open circuit voltage (OCV or OCP) equation
    funcs.OCV_n = OCV_LiC6_Oregan2021
end

function system_LCO_LiC6_Oregan2021(θ, funcs, cathode, anode;
    # State-of-charge between 0 and 1
    SOC = 1.0,
    ### Cell discretizations, `N` ###
    # Volume discretizations per cathode
